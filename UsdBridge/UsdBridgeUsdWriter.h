...
public:
    ...
    bool InitializeZmq(const char* endpoint = nullptr);
    bool IsZmqInitialized() const { return zmqInitialized; }
    // Added helper to get the target endpoint for error handling
    const std::string& GetZmqTargetEndpoint() const { return zmqTargetEndpoint; }

    bool CreateZipFile(const std::string& zipFilePath);
    //end edit here ==================================================================================================
